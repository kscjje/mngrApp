...
function createTree(selector, items) {
	...
	treeCategory=$(selector).dxTreeList({
	    ...
	    columns: [
	    	...
	    	{dataField:'CTGDESC',	caption: '분류설명',},
	    	...
	    	/*{dataField:'CTGLVL',caption: '분류레벨',	visible:false},*/
	    ],
	    ...
	    onEditingStart: function(e){
	    	treeCategory.option("editing.popup.title", "운영 상품 분류 수정");
	     ...
	     onInitNewRow: function(e){
	    	 treeCategory.option("editing.popup.title", "운영 상품 분류 신규");
	    	 var curr = selectedData();
	     ...
	     onFocusedRowChanged(e) {
	    	 ...
	    	 //console.log(e);
	    	 if(e.row.data.CTGLVL==2){
	    		 $('#regChild').dxButton('instance').option('disabled',true);
	    	 }else{
	    		 $('#regChild').dxButton('instance').option('disabled',false);
	    	 }
	     },
